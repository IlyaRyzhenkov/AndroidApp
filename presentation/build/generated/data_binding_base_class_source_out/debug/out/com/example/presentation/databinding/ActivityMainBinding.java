...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull FrameLayout fragmentLayout,
      @NonNull DrawerLayout mainLayout, @NonNull NavigationView navigationView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((DrawerLayout) rootView, fragmentLayout, mainLayout,
          navigationView);
    }
